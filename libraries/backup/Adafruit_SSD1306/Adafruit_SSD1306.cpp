...
void Adafruit_SSD1306::begin(uint8_t vccstate, uint8_t i2caddr) {
  ...
  if (sid != -1)
  {
    ...
    pinMode(dc, OUTPUT);
    pinMode(cs, OUTPUT);
    clkport     = (volatile uint8_t*)portOutputRegister(digitalPinToPort(sclk));
    clkpinmask  = digitalPinToBitMask(sclk);
    mosiport    = (volatile uint8_t*)portOutputRegister(digitalPinToPort(sid));
    mosipinmask = digitalPinToBitMask(sid);
    csport      = (volatile uint8_t*)portOutputRegister(digitalPinToPort(cs));
    cspinmask   = digitalPinToBitMask(cs);
    dcport      = (volatile uint8_t*)portOutputRegister(digitalPinToPort(dc));
